...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 11 août 2025 à 11:56
...
CREATE TABLE `joueurs` (
  ...
  `classement_simple` varchar(5) NOT NULL DEFAULT '',
  `classement_double` varchar(5) NOT NULL DEFAULT '',
  `classement_mixte` varchar(5) NOT NULL DEFAULT '',
...
(1, 'DELANGUE', 'Baptiste', '07494875', 'D9', 'P10', 'D9', 'baptiste.jpg', '2025-07-29 11:33:18', 0, 0, 0, 0, 0, 0),
(2, 'CORNET', 'Constance', '07032078', 'D9', 'P11', 'D9', 'Constance.jpg', '2025-07-29 11:33:18', 0, 0, 0, 0, 0, 0),
(3, 'DOHEN', 'Marie', '07440250', 'D9', 'P10', 'D9', 'marie.jpg', '2025-07-29 11:33:18', 0, 0, 0, 0, 0, 0),
(4, 'DELATTRE', 'Pierre', '07492441', 'D9', 'P10', 'P10', 'pierre.jpg', '2025-07-29 11:33:18', 0, 0, 0, 0, 0, 0),
(5, 'DELEFOSSE', 'Vincent', '07485284', 'D9', 'P10', 'D9', 'vincent.jpg', '2025-07-29 11:33:18', 0, 0, 0, 0, 0, 0),
(6, 'HOMBERT', 'Antoine', '00629197', 'D9', 'P10', 'P10', 'antoine.jpg', '2025-07-29 11:33:18', 0, 0, 0, 0, 0, 0),
(7, 'TERGEMINA', 'Benoît', '07439195', 'D9', 'P10', 'P10', 'ginting.jpg', '2025-07-29 11:33:18', 0, 0, 0, 0, 0, 0);
...
INSERT INTO `match_details` (`id`, `joueur_id`, `fixture_id`, `adversaire_id`, `nom_adversaire`, `opponent_team`, `binome`, `date_match`, `journee`, `lieu`, `score`, `resultat`, `type_match`, `is_prochain`) VALUES
(123, 1, 9, NULL, 'Nathan ZANELLI', 'ASDB 2', NULL, '2024-11-17 11:30:00', 1, 'Complexe sportif de la Sensée, 62112 Corbehem', '21-7 21-14', 'victoire', 'simple', 0),
(124, 4, 9, NULL, 'Alexis KWIATEK', 'ASDB 2', NULL, '2024-11-17 11:30:00', 1, 'Complexe sportif de la Sensée, 62112 Corbehem', '21-7 21-11', 'victoire', 'simple', 0),
(125, 7, 9, NULL, 'Romain PLOUVIEZ', 'ASDB 2', NULL, '2024-11-17 11:30:00', 1, 'Complexe sportif de la Sensée, 62112 Corbehem', '11-21 7-21', 'défaite', 'simple', 0),
(126, 3, 9, NULL, 'Sandrine HOLLANDE', 'ASDB 2', NULL, '2024-11-17 11:30:00', 1, 'Complexe sportif de la Sensée, 62112 Corbehem', '21-0 21-4', 'victoire', 'simple', 0),
(128, 7, 9, NULL, 'Jérémi FOVELLE & Alexis KWIATEK', 'ASDB 2', 'Antoine HOMBERT', '2024-11-17 11:30:00', 1, 'Complexe sportif de la Sensée, 62112 Corbehem', '21-11 21-7', 'victoire', 'double', 0),
(130, 3, 9, NULL, 'Romain PLOUVIEZ & Pauline DRANCOURT', 'ASDB 2', 'Baptiste DELANGUE', '2024-11-17 11:30:00', 1, 'Complexe sportif de la Sensée, 62112 Corbehem', '14-21 12-21', 'défaite', 'mixte', 0),
(131, 4, NULL, NULL, 'Florent DELRUE', 'VABC 2', NULL, '2024-11-17 14:00:00', 1, 'Complexe sportif de la Sensée, 62112 Corbehem', '16-21 15-21', 'défaite', 'simple', 0),
(132, 7, NULL, NULL, 'Remy FREVILLE', 'VABC 2', NULL, '2024-11-17 14:00:00', 1, 'Complexe sportif de la Sensée, 62112 Corbehem', '7-21 11-21', 'défaite', 'simple', 0),
(133, 6, NULL, NULL, 'Julian VAN AUTREEVE', 'VABC 2', NULL, '2024-11-17 14:00:00', 1, 'Complexe sportif de la Sensée, 62112 Corbehem', '21-9 21-3', 'victoire', 'simple', 0),
(134, 3, NULL, NULL, 'Eloïse CHARMETANT', 'VABC 2', NULL, '2024-11-17 14:00:00', 1, 'Complexe sportif de la Sensée, 62112 Corbehem', '16-21 16-21', 'défaite', 'simple', 0),
(135, 4, NULL, NULL, 'Remy FREVILLE & Sullivan LEFEBVRE', 'VABC 2', 'Antoine HOMBERT', '2024-11-17 14:00:00', 1, 'Complexe sportif de la Sensée, 62112 Corbehem', '13-21 15-21', 'défaite', 'double', 0),
(137, 1, NULL, NULL, 'Florent DELRUE & Maëla VAN EECKHOUTTE', 'VABC 2', 'Marie DOHEN', '2024-11-17 14:00:00', 1, 'Complexe sportif de la Sensée, 62112 Corbehem', '22-24 17-21', 'défaite', 'mixte', 0),
(139, 1, 11, NULL, 'Kilian DOUTREMEPUICH', 'SZ 3', NULL, '2024-12-01 09:00:00', 2, 'Complexe Sportif Calypso, 62100 Calais', '17-21 8-21', 'défaite', 'simple', 0),
(140, 7, 11, NULL, 'Axel ROUSSEL', 'SZ 3', NULL, '2024-12-01 09:00:00', 2, 'Complexe Sportif Calypso, 62100 Calais', '21-13 21-15', 'victoire', 'simple', 0),
(141, 6, 11, NULL, 'Gauthier HAUTECOEUR', 'SZ 3', NULL, '2024-12-01 09:00:00', 2, 'Complexe Sportif Calypso, 62100 Calais', '21-13 21-14', 'victoire', 'simple', 0),
(142, 3, 11, NULL, 'Lalie VERHEYDE', 'SZ 3', NULL, '2024-12-01 09:00:00', 2, 'Complexe Sportif Calypso, 62100 Calais', '21-8 24-22', 'victoire', 'simple', 0),
(144, 7, 11, NULL, 'Michel HENEMAN & Axel ROUSSEL', 'SZ 3', 'Antoine HOMBERT', '2024-12-01 09:00:00', 2, 'Complexe Sportif Calypso, 62100 Calais', '16-21 14-21', 'défaite', 'double', 0),
(146, 2, 11, NULL, 'Gauthier HAUTECOEUR & Elodie WARNIER', 'SZ 3', 'Pierre DELATTRE', '2024-12-01 09:00:00', 2, 'Complexe Sportif Calypso, 62100 Calais', '22-20 21-19', 'victoire', 'mixte', 0),
(147, 1, 12, NULL, 'Romain JOAN', 'CBC 4', NULL, '2024-12-01 11:30:00', 2, 'Complexe Sportif Calypso, 62100 Calais', '16-21 6-21', 'défaite', 'simple', 0),
(148, 4, 12, NULL, 'Louis DERNIS', 'CBC 4', NULL, '2024-12-01 11:30:00', 2, 'Complexe Sportif Calypso, 62100 Calais', '21-16 21-12', 'victoire', 'simple', 0),
(149, 6, 12, NULL, 'Sylvain LEMAITRE', 'CBC 4', NULL, '2024-12-01 11:30:00', 2, 'Complexe Sportif Calypso, 62100 Calais', '21-10 21-9', 'victoire', 'simple', 0),
(150, 2, 12, NULL, 'Valentine DRIN', 'CBC 4', NULL, '2024-12-01 11:30:00', 2, 'Complexe Sportif Calypso, 62100 Calais', '21-2 21-3', 'victoire', 'simple', 0),
(151, 4, 12, NULL, 'Louis DERNIS & Romain JOAN', 'CBC 4', 'Benoît TERGEMINA', '2024-12-01 11:30:00', 2, 'Complexe Sportif Calypso, 62100 Calais', '21-18 7-21 21-18', 'victoire', 'double', 0),
(153, 1, 12, NULL, 'Sylvain LEMAITRE & Candice DELRUE', 'CBC 4', 'Marie DOHEN', '2024-12-01 11:30:00', 2, 'Complexe Sportif Calypso, 62100 Calais', '9-21 21-18 21-18', 'victoire', 'mixte', 0),
(155, 4, 13, NULL, 'Jean Charles VERVA', 'ABC 2', NULL, '2024-12-01 14:00:00', 2, 'Complexe Sportif Calypso, 62100 Calais', '21-11 21-11', 'victoire', 'simple', 0),
(156, 7, 13, NULL, 'Noa VERVA', 'ABC 2', NULL, '2024-12-01 14:00:00', 2, 'Complexe Sportif Calypso, 62100 Calais', '17-21 22-20 21-16', 'victoire', 'simple', 0),
(157, 6, 13, NULL, 'Pierre FIEVEZ', 'ABC 2', NULL, '2024-12-01 14:00:00', 2, 'Complexe Sportif Calypso, 62100 Calais', '16-21 21-10 21-14', 'victoire', 'simple', 0),
(158, 2, 13, NULL, 'Lilou FABRE', 'ABC 2', NULL, '2024-12-01 14:00:00', 2, 'Complexe Sportif Calypso, 62100 Calais', '11-21 21-10 14-21', 'défaite', 'simple', 0),
(159, 4, 13, NULL, 'Pierre FIEVEZ & Noa VERVA', 'ABC 2', 'Benoît TERGEMINA', '2024-12-01 14:00:00', 2, 'Complexe Sportif Calypso, 62100 Calais', '21-13 23-21', 'victoire', 'double', 0),
(161, 1, 13, NULL, 'Benjamin CHRETIEN & Laurine HELLEC', 'ABC 2', 'Marie DOHEN', '2024-12-01 14:00:00', 2, 'Complexe Sportif Calypso, 62100 Calais', '21-12 21-16', 'victoire', 'mixte', 0),
(163, 6, NULL, NULL, 'Samuel LOUGEZ', 'SBC 3', NULL, '2025-01-26 09:00:00', 3, 'Salle du Lycée Branly, 62200 Boulogne-sur-Mer', '9-21 14-21', 'défaite', 'simple', 0),
(164, 1, NULL, NULL, 'Hugo HEDOIRE', 'SBC 3', NULL, '2025-01-26 09:00:00', 3, 'Salle du Lycée Branly, 62200 Boulogne-sur-Mer', '21-18 16-21 21-15', 'victoire', 'simple', 0),
(165, 7, NULL, NULL, 'Vincent BRASSEUR', 'SBC 3', NULL, '2025-01-26 09:00:00', 3, 'Salle du Lycée Branly, 62200 Boulogne-sur-Mer', '12-21 13-21', 'défaite', 'simple', 0),
(166, 3, NULL, NULL, 'Pauline LUCAS', 'SBC 3', NULL, '2025-01-26 09:00:00', 3, 'Salle du Lycée Branly, 62200 Boulogne-sur-Mer', '18-21 19-21', 'défaite', 'simple', 0),
(168, 7, NULL, NULL, 'Vincent BRASSEUR & Bruno SAUVAGE', 'SBC 3', 'Baptiste DELANGUE', '2025-01-26 09:00:00', 3, 'Salle du Lycée Branly, 62200 Boulogne-sur-Mer', '13-21 10-21', 'défaite', 'double', 0),
(170, 2, NULL, NULL, 'Bruno SAUVAGE & Pauline LUCAS', 'SBC 3', 'Vincent DELEFOSSE', '2025-01-26 09:00:00', 3, 'Salle du Lycée Branly, 62200 Boulogne-sur-Mer', '21-14 8-21 24-22', 'victoire', 'mixte', 0),
(171, 6, NULL, NULL, 'Benjamin THUEUX', 'CBC 5', NULL, '2025-01-26 11:30:00', 3, 'Salle du Lycée Branly, 62200 Boulogne-sur-Mer', '21-18 21-11', 'victoire', 'simple', 0),
(172, 5, NULL, NULL, 'Léo MAEGHT', 'CBC 5', NULL, '2025-01-26 11:30:00', 3, 'Salle du Lycée Branly, 62200 Boulogne-sur-Mer', '21-10 21-13', 'victoire', 'simple', 0),
(173, 7, NULL, NULL, 'Henry BEDOY', 'CBC 5', NULL, '2025-01-26 11:30:00', 3, 'Salle du Lycée Branly, 62200 Boulogne-sur-Mer', '21-7 21-13', 'victoire', 'simple', 0),
(174, 3, NULL, NULL, 'Stéphanie MALFAIT', 'CBC 5', NULL, '2025-01-26 11:30:00', 3, 'Salle du Lycée Branly, 62200 Boulogne-sur-Mer', '21-15 21-7', 'victoire', 'simple', 0),
(175, 1, NULL, NULL, 'Dominique GOIDIN & Benjamin THUEUX', 'CBC 5', 'Antoine HOMBERT', '2025-01-26 11:30:00', 3, 'Salle du Lycée Branly, 62200 Boulogne-sur-Mer', '21-15 22-20', 'victoire', 'double', 0),
(177, 5, NULL, NULL, 'Léo MAEGHT & Lily HAGNERE', 'CBC 5', 'Constance CORNET', '2025-01-26 11:30:00', 3, 'Salle du Lycée Branly, 62200 Boulogne-sur-Mer', '21-9 21-9', 'victoire', 'mixte', 0),
(179, 6, NULL, NULL, 'Bastien BIZE', 'VOC 3', NULL, '2025-01-26 14:00:00', 3, 'Salle du Lycée Branly, 62200 Boulogne-sur-Mer', '21-15 21-19', 'victoire', 'simple', 0),
(180, 1, NULL, NULL, 'Quentin ROLAND', 'VOC 3', NULL, '2025-01-26 14:00:00', 3, 'Salle du Lycée Branly, 62200 Boulogne-sur-Mer', '16-21 13-21', 'défaite', 'simple', 0),
(181, 5, NULL, NULL, 'Thierry LELEU', 'VOC 3', NULL, '2025-01-26 14:00:00', 3, 'Salle du Lycée Branly, 62200 Boulogne-sur-Mer', '21-18 19-21 21-16', 'victoire', 'simple', 0),
(182, 2, NULL, NULL, 'Alyssia RYSSEN', 'VOC 3', NULL, '2025-01-26 14:00:00', 3, 'Salle du Lycée Branly, 62200 Boulogne-sur-Mer', '21-14 21-10', 'victoire', 'simple', 0),
(183, 6, NULL, NULL, 'Bastien BIZE & Quentin ROLAND', 'VOC 3', 'Benoît TERGEMINA', '2025-01-26 14:00:00', 3, 'Salle du Lycée Branly, 62200 Boulogne-sur-Mer', '15-21 18-21', 'défaite', 'double', 0),
(185, 1, NULL, NULL, 'Thierry LELEU & Sandrine FUCHS', 'VOC 3', 'Marie DOHEN', '2025-01-26 14:00:00', 3, 'Salle du Lycée Branly, 62200 Boulogne-sur-Mer', '21-13 21-12', 'victoire', 'mixte', 0);
...
--
-- Contraintes pour la table `match_details`
--
ALTER TABLE `match_details`
  ADD CONSTRAINT `match_details_ibfk_1` FOREIGN KEY (`joueur_id`) REFERENCES `joueurs` (`id`);
...
--
ALTER TABLE `rencontres`
  ADD CONSTRAINT `fk_rencontres_dom` FOREIGN KEY (`domicile_id`) REFERENCES `adversaires` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_rencontres_ext` FOREIGN KEY (`exterieur_id`) REFERENCES `adversaires` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_rencontres_lieux` FOREIGN KEY (`lieu_id`) REFERENCES `lieux` (`id`) ON UPDATE CASCADE;
